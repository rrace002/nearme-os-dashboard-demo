...
This page is a companion to the [style guide](/contribute/style-guide-for-n8n-docs.md): the style guide covers writing style, formatting, and structure, and this page is the source of truth for product terminology.
...
+The Workflow menu icon is `three-dots-horizontal.png`; the Options menu icon is `three-dot-options-menu.png`. Use these inline when referring to these menus. See the [style guide](/contribute/style-guide-for-n8n-docs.md#images) for how to format an inline icon.
