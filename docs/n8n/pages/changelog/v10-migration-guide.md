...
Your existing workflows will use the legacy order, while new workflows will execute using the n8n 1.0 order. You can configure the execution order for each workflow in [workflow settings](/build/manage-workflows/configure-workflow-settings.md).
