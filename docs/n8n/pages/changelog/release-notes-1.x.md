...
[![Thumbnail linking to a Studio video walkthrough of the new MCP Server Trigger and Client Tool nodes](/files/4FU5519xBx1GrT2o53gn)](https://youtu.be/45WPU7P-1QQ?feature=shared)
...
[![Thumbnail linking to a Studio video demoing the overhauled Code node editing experience](/files/paRsb9amxse4dNLLtV4J)](https://youtu.be/De1E58MPaMQ?t=645)
{% endhint %}
...
[Read more about user roles](/administer/manage-users-and-access/understand-instance-roles.md)
{% endhint %}
...
Please note that this version contains breaking changes if upgrading from a `0.x.x` version. For full details, refer to the [n8n 1.0 migration guide](/changelog/v10-migration-guide.md).
{% endhint %}
...
Please note that this version contains breaking changes. For full details, refer to the [n8n 1.0 migration guide](/changelog/v10-migration-guide.md).
{% endhint %}

This is n8n's version one release.

For full details, refer to the [n8n 1.0 migration guide](/changelog/v10-migration-guide.md).
