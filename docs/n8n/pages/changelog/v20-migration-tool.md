...
![Migration compatibility report showing a workflow-compatible count and Workflow issues / Instance issues tabs](/files/JFSye1et85vs3fORBUcj)

You can see all breaking changes for n8n 2.0 [on this page](/changelog/v20-breaking-changes.md).
