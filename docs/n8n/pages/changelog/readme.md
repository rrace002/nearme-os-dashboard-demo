...
For guidance on major version upgrades, see [v3.0 breaking changes](/changelog/v30-breaking-changes.md), [v2.0 breaking changes](/changelog/v20-breaking-changes.md), [v2.0 migration tool](/changelog/v20-migration-tool.md), and [v1.0 migration guide](/changelog/v10-migration-guide.md).
{% endhint %}
...
**Released:** 2026-09-02 in [n8n 2.36](/changelog/release-notes.md#n8n235)
...
![Agent using tool services available with Gateway credits](/files/KXGXarepvSIwD7JmMxZZ)
...
![Select Gateway credits in the Credetial dropdown ](/files/rOKvFAdqSt6eeLZG5rlL)
...
**Released:** 2026-08-18 in [n8n 2.35](/changelog/release-notes.md#n8n235)
...
It installs n8n with Docker Compose and pre-configures the sandbox and SearXNG web search, both free. Open the editor, add your model API key in the instance's AI settings, and start building. On an existing Docker install, the [AI Assistant setup guide](/deploy/host-n8n/configure-n8n/set-up-ai-assistant.md) covers the sandbox and search options for each deployment shape, in environment variables or in the UI.

AI Assistant requires Docker. npm installs will stop working with n8n 3.0 in October, so new installs should use the [one-line setup](/deploy/host-n8n/install-options/one-line-setup.md) or [Docker Compose](/deploy/host-n8n/install-options/install-using-docker-compose.md).
...
**Released:** 2026-07-28 in [n8n 2.33](/changelog/release-notes.md#n8n233)
...
Learn more in the [Microsoft Excel (SharePoint) node documentation](/integrations/builtin/app-nodes/n8n-nodes-base.microsoftexcelsharepoint.md).
...
Learn more in the [Approvals in Slack documentation](/integrations/builtin/app-nodes/n8n-nodes-base.slack/approvals.md).
...
The [GitHub node](/integrations/builtin/app-nodes/n8n-nodes-base.github.md) and [GitHub Trigger](/integrations/builtin/trigger-nodes/n8n-nodes-base.githubtrigger.md) can now authenticate as a GitHub App, alongside the existing personal access token and OAuth2 options.
...
Learn more in the [insights retention documentation](/administer/observe-and-log/track-usage-with-insights.md#disable-or-configure-insights-metrics-collection).
...
**Released:** 2026-06-23 in [n8n 2.28](/changelog/release-notes.md#n8n228)
...
The [GitHub node](/integrations/builtin/app-nodes/n8n-nodes-base.github.md) now has a dedicated Pull Request resource. The whole life of a pull request is available as node operations, instead of hand-rolled HTTP Request calls against the GitHub API.
...
Refer to the [GitHub node documentation](/integrations/builtin/app-nodes/n8n-nodes-base.github.md#operations) for the full list of operations.
...
Learn more in the [Microsoft credentials documentation](/integrations/builtin/credentials/microsoft.md).
...
**Released:** 2026-06-02 in [n8n 2.25.1](/changelog/release-notes.md#n8n2251)
...
Learn more in the [custom span attributes documentation](/deploy/host-n8n/keep-n8n-running/trace-executions-with-opentelemetry.md#custom-span-attributes).
...
You can now mark projects, folders, workflows, and data tables as [favorites](/build/manage-workflows/favorite-items.md), so the resources you work with every day are one click away instead of a search away.
...
*Full team access released in n8n 2.13 (2026-03-16).* Project admins now manage their own vault connections from **Project Settings > External Secrets**. Instance-level connections shared with them appear as read-only. Project editors can use project-scoped secrets in credentials once an instance admin enables access with the **System Roles** toggle under **Settings > External Secrets**, or through custom roles for finer control. [Custom roles](/administer/manage-users-and-access/set-permissions-and-roles-rbac/create-custom-roles.md) gained five secrets scopes: list, read, create, update, and delete. Instance admins and owners no longer need to be project members for secrets to resolve.
...
**Released:** 2026-03-03 in [n8n 2.11](/changelog/release-notes.md#n8n211)
...
**Released:** 2026-02-13 in [n8n 2.8.3](/changelog/release-notes.md#n8n28)
...
The project role selector now splits built-in system roles and [custom roles](/administer/manage-users-and-access/set-permissions-and-roles-rbac/create-custom-roles.md) into separate sections, so a long list of custom roles no longer buries the defaults. Hovering over any role shows a summary of its configured permissions, with an option to open the full permission details. Previously you had to leave the assignment flow and open the role itself to check what you were about to grant.
...
**Released:** 2025-12-15 in [n8n 2.1](/changelog/release-notes.md#n8n21)
