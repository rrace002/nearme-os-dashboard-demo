...
The Motorhead project is no longer maintained. The Motorhead node is deprecated from n8n 2.8.0. Refer to [Deprecated and versioned nodes](/integrations/builtin/deprecated-nodes.md) for more information.
{% endhint %}
