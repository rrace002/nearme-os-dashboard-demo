> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.datetime.md).
...
You can work with data and time in the Code node, and in expressions in any node. n8n supports Luxon to help work with date and time in JavaScript. Refer to [Date and time with Luxon](/build/work-with-data/handle-special-data-types/work-with-dates-and-times.md) for more information.
{% endhint %}
...
The Date & Time node uses [Luxon](https://moment.github.io/luxon). You can also use Luxon in the [Code](/build/code-in-n8n/using-the-code-node.md) node and [expressions](/build/work-with-data/expressions-versus-data-nodes.md). Refer to [Date and time with Luxon](/build/work-with-data/handle-special-data-types/work-with-dates-and-times.md) for more information.
