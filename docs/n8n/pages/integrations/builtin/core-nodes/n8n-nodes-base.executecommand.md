...
The Execute Command node can introduce significant security risks in environments that operate with untrusted users. Because of this, the node is [disabled](/deploy/host-n8n/configure-n8n/security/block-specific-nodes.md#exclude-nodes) by default from n8n 2.0.
{% endhint %}
