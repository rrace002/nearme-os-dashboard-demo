> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/integrations/builtin/app-nodes/n8n-nodes-base.kafka.md).
...
To consume messages with version 2, including guidance on consumer group IDs, refer to the [Kafka Trigger version 2 preview](/integrations/builtin/trigger-nodes/n8n-nodes-base.kafkatrigger.md#kafka-trigger-version-2-preview).
