...
You can also connect an MCP client to [the n8n docs MCP server](/connect/connect-to-n8n-docs-mcp-server.md) so AI tools can search the docs, or [create your own node](/connect/create-nodes.md) to add a custom integration to n8n.
