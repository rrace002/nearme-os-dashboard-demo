...
![Code examples with arrows linking the credential class's name property to the matching name field in the node's credentials array](/files/StM1hqmTtyymHLcwJ1Xs)
