...
* [Summarize](/integrations/builtin/core-nodes/n8n-nodes-base.summarize.md): aggregate items together, like Excel pivot tables.
...
See [Work with data](/build/work-with-data.md) for other ways to reference, transform, and structure data.
