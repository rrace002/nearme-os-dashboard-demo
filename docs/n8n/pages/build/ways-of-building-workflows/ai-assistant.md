...
* **Connect MCP servers:** connect a server from the [MCP servers](/build/integrate-ai/mcp-servers.md) registry directly to the assistant, both to perform tasks and to gather context while it builds workflows for you.
...
See [Ways of building workflows](/build/ways-of-building-workflows.md) for other approaches.
