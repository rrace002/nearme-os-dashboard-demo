...
![A basic workflow with a sticky note attached](/files/0gYO31OtxtKovoJGe4Uk)
...
* Change the color: select the **Options** menu <img src="/files/u571i29h1qOyVdUCmDJP" alt="Options icon" data-size="line"> to open the color selector.
...
See [Workflow components](/build/understand-workflows/workflow-components.md) for other elements you can add to a workflow.
