...
Users can share workflows they created. Instance owners, and users with the admin role, can view and share all workflows in the instance. Refer to [Instance roles](/administer/manage-users-and-access/understand-instance-roles.md) for more information about owners and admins.
...
![Pop-up explaining that the project shares this workflow with everyone in it](/files/rt7H2YtMuij2p1dwe8Bn)
