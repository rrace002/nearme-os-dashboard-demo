> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/build/integrate-ai/ai-examples/human-in-the-loop-for-tools.md).
...
| [Discord](/integrations/builtin/app-nodes/n8n-nodes-base.discord.md)                    | Send approval requests to a Discord channel       |
| [Telegram](/integrations/builtin/app-nodes/n8n-nodes-base.telegram.md)                  | Send approval requests through Telegram           |
...
| [Gmail](/integrations/builtin/app-nodes/n8n-nodes-base.gmail.md)                        | Send approval requests via email                  |
| [WhatsApp Business Cloud](/integrations/builtin/app-nodes/n8n-nodes-base.whatsapp.md)   | Send approval requests through WhatsApp           |
...
The [`$fromAI()` function](/build/integrate-ai/ai-examples/use-ai-for-parameters.md) works with tools connected to human review steps. This means the AI can dynamically specify tool parameters, and those AI-determined values are what the human reviewer sees and approves.
...
* [AI Agent node](/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.agent.md)
* [Tools Agent](/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.agent/tools-agent.md)
* [What is a tool in AI?](/build/integrate-ai/understand-ai-components/how-tools-work.md)
