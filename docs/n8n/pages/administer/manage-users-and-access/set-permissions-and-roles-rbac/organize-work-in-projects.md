...
You can favorite a team project to pin it for quick access. Open the project and select the star icon in the project header, or select its **three-dot menu** and select **Favorite**. See [Favorite items](/build/manage-workflows/favorite-items.md) for details, including how to favorite workflows, folders, and data tables the same way.
