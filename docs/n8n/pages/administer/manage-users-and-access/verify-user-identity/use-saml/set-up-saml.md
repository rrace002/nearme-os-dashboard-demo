...
Configuring SAML using environment variables instead of the UI is available from n8n 2.18.0. See [SSO environment variables](/deploy/host-n8n/configure-n8n/basic-configuration/use-environment-variables/sso.md).
{% endhint %}
