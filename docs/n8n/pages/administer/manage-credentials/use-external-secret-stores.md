...
Granting project editors and project admins access to external secrets is available from n8n 2.13.0. Before n8n 2.13.0, using external secrets in an [RBAC project](/administer/manage-users-and-access/set-permissions-and-roles-rbac.md) required an [instance owner or instance admin](/administer/manage-users-and-access/understand-instance-roles.md) as a member of the project.
{% endhint %}
...
See [Manage credentials](/administer/manage-credentials.md) for other ways to secure and share credentials.
