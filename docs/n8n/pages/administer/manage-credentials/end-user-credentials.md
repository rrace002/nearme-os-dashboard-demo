...
* **Supported triggers:** End-user credential resolution works with the manual trigger, [Chat Hub](/build/ways-of-building-workflows/chat-hub.md), the MCP Server Trigger, and the [n8n Form Trigger](/integrations/builtin/core-nodes/n8n-nodes-base.formtrigger.md).
