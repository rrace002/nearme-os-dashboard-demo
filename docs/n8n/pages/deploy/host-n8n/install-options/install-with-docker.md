...
{% hint style="warning" %}
**This content is outdated.** Please refer to [Install using Docker Compose](/deploy/host-n8n/install-options/install-using-docker-compose.md) for the recommended installation method.
{% endhint %}
...
![Docker Desktop Images tab with the row context menu open and Pull available](/files/PR3cvEHSw9Fnj0BpGkM1)
