> For the complete documentation index, see [llms.txt](https://docs.n8n.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.n8n.io/deploy/host-n8n/keep-n8n-running/set-up-logging.md).
...
n8n Self-hosted Enterprise tier includes [Log streaming](/administer/observe-and-log/stream-logs-to-external-systems.md), in addition to the logging options described in this document.
{% endhint %}

\## How do I set up logging in n8n?

To set up logging in n8n, you need to set the following environment variables (you can also set the values in the [configuration file](/deploy/host-n8n/configure-n8n/basic-configuration/use-environment-variables.md))
