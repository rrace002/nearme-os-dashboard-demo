...
The `update:workflow` command is deprecated from n8n 2.0 and will be removed. Use [`publish:workflow`](#publish-a-workflow) and [`unpublish:workflow`](#unpublish-a-workflow) instead. See the [n8n 2.0 breaking changes](/changelog/v20-breaking-changes.md) for details.
{% endhint %}
