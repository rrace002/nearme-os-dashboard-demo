...
To prevent all communication with n8n's servers, refer to [Isolate n8n](/deploy/host-n8n/configure-n8n/basic-configuration/configuration-examples/isolate-n8n.md).

## Related resources <a href="#related-resources" id="related-resources"></a>

* [Deployment environment variables](/deploy/host-n8n/configure-n8n/basic-configuration/use-environment-variables/deployment.md): More information on these environment variables.
* [Configuration](/deploy/host-n8n/configure-n8n/basic-configuration.md): How to set environment variables.
