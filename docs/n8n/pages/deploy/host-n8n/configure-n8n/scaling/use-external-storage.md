...
Activate your [license key](/deploy/host-n8n/configure-n8n/manage-your-license.md) before you enable external storage. n8n won't start in `s3` binary data mode without a valid license: set `N8N_DEFAULT_BINARY_DATA_MODE` to another mode or upgrade your plan.
{% endhint %}
...
Activate your [license key](/deploy/host-n8n/configure-n8n/manage-your-license.md) before you enable external storage. n8n won't start in `azure` binary data mode without a valid license: set `N8N_DEFAULT_BINARY_DATA_MODE` to another mode or upgrade your plan.
{% endhint %}
