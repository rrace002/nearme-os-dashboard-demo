...
Insights gives instance owners and admins visibility into how workflows perform over time. Refer to [Insights](/administer/observe-and-log/track-usage-with-insights.md) for details.
...
Raising the values delays compaction. That adds more rows to `insights_by_period` and increases database usage. For how this relates to retention, see [Insights](/administer/observe-and-log/track-usage-with-insights.md#disable-or-configure-insights-metrics-collection).
{% endhint %}
